...
"""
OpenRouter example using the reusable chat UI.
Set OPENROUTER_API_KEY and use the openrouter config.
"""
...
def main() -> None:
    ...
    config = os.path.join(root, ".config_examples", "openrouter", "openrouter_config.yaml")
