...
class TestEnhancedExceptions:
    ...
    def test_rate_limit_error(self):
        ...
        error = RateLimitError(
            message="Too many requests", retry_after=60, limit_type="api_calls"
        )
...
class TestErrorHandler:
    ...
    def test_retry_with_callback(self):
        ...
        @handler.with_retry(max_attempts=3, initial_delay=0.1, on_retry=on_retry)
        def flaky_function():
    ...
    def test_safe_execute(self):
        ...
        result = ErrorHandler.safe_execute(risky_function, 0, default=-1)
        assert result == -1
