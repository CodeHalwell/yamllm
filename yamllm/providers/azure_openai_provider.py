"""
Azure OpenAI provider implementation for YAMLLM.

This module provides an implementation of the BaseProvider interface for Azure OpenAI.
"""
...
class AzureOpenAIProvider(BaseProvider):
    ...
    This class implements the BaseProvider interface for Azure OpenAI.
    """
    ...
    def __init__(self, api_key: str, model: str, base_url: Optional[str] = None, **kwargs):
        ...
        Args:
            ...
            model (str): The model to use (deployment name in Azure OpenAI).
            base_url (str): The endpoint URL for Azure OpenAI service.
    ...
    def handle_streaming_with_tool_detection(self, messages: List[Message], params: Dict[str, Any], 
                                           tools: Optional[List[ToolDefinition]] = None) -> str:
        """
        Handle streaming with tool detection for Azure OpenAI.
    ...
    def process_tool_calls(self, messages: List[Message], model_message: Any, 
        ...
        """
        Process tool calls from Azure OpenAI.
    ...
    def create_embedding(self, text: str) -> bytes:
        """
        Create an embedding for the given text using Azure OpenAI's API.
