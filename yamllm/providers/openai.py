...
class OpenAIProvider(BaseProvider):
    ...
    def get_completion(
        ...
        **kwargs,
        ...
        try:
            ...
            raise ProviderError(
                "OpenAI", f"API error: {str(e)}", original_error=e
            ) from e
    ...
    def get_streaming_completion(
        ...
        **kwargs,
        ...
        try:
            ...
            raise ProviderError(
                "OpenAI", f"Streaming error: {str(e)}", original_error=e
            ) from e
        ...
        **kwargs,
        ...
        while iterations < max_iterations:
            ...
            try:
                ...
                formatted_tool_calls = self.format_tool_calls(
                ...
                raise ProviderError(
                    "OpenAI", f"Tool processing error: {str(e)}", original_error=e
                ) from e
    ...
    def create_embedding(
        ...
        try:
            ...
            raise ProviderError(
                "OpenAI", f"Embedding error: {str(e)}", original_error=e
            ) from e
    ...
    def process_streaming_tool_calls(
        ...
        max_iterations: int = 10,
        **kwargs,
    ) -> Iterator[Union[Dict[str, Any], ChatCompletionChunk]]:
        """
        ...
        while iterations < max_iterations:
            ...
            try:
                ...
                logger.error(
                    f"OpenAI API error during streaming tool processing: {str(e)}"
                )
